local svargrondArenaEnter = MoveEvent()
svargrondArenaEnter:type("stepin")

function svargrondArenaEnter.onStepIn(creature, item, position, fromPosition)
...
svargrondArenaEnter:aid(50168)
svargrondArenaEnter:register()
