...
local newFrontierMinotaurBoss = MoveEvent()
newFrontierMinotaurBoss:type("stepin")

function newFrontierMinotaurBoss.onStepIn(creature, item, position, fromPosition)
...
newFrontierMinotaurBoss:aid(50172)
newFrontierMinotaurBoss:register()
