...
local newFrontierTrap = MoveEvent()
newFrontierTrap:type("stepin")

function newFrontierTrap.onStepIn(creature, item, position, fromPosition)
...
newFrontierTrap:aid(50173)
newFrontierTrap:register()
