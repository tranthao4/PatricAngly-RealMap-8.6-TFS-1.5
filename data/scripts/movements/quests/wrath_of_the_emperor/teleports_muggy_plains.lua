...
local woteTeleportsMuggyPlains = MoveEvent()
woteTeleportsMuggyPlains:type("stepin")

function woteTeleportsMuggyPlains.onStepIn(creature, item, position, fromPosition)
...
woteTeleportsMuggyPlains:aid(12380, 12381)
woteTeleportsMuggyPlains:register()
