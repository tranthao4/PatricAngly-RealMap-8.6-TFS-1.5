local teleportNTiles = TalkAction("/a")

function teleportNTiles.onSay(player, words, param)
...
teleportNTiles:separator(" ")
teleportNTiles:access(true)
teleportNTiles:register()
