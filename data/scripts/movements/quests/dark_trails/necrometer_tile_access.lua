local darkTrailsNecrometer = MoveEvent()
darkTrailsNecrometer:type("stepin")

function darkTrailsNecrometer.onStepIn(creature, item, position, fromPosition)
...
darkTrailsNecrometer:aid(50151)
darkTrailsNecrometer:register()
