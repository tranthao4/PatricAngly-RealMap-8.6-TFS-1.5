local config = {
    ...
    {storageKey = 210016, teleportPosition = Position(33255, 32678, 7)} -- north Ankrahmun
}
...
local nightmareIslesTeleports = MoveEvent()
nightmareIslesTeleports:type("stepin")

function nightmareIslesTeleports.onStepIn(creature, item, position, fromPosition)
...
nightmareIslesTeleports:uid(64001, 64002, 64003)
nightmareIslesTeleports:register()
