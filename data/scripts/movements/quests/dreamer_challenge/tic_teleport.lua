...
local dcTicTeleport = MoveEvent()
dcTicTeleport:type("stepin")

function dcTicTeleport.onStepIn(creature, item, position, fromPosition)
...
dcTicTeleport:aid(2256)
dcTicTeleport:register()
