...
local qobThirdSealFlame = MoveEvent()
qobThirdSealFlame:type("stepin")

function qobThirdSealFlame.onStepIn(creature, item, position, fromPosition)
...
qobThirdSealFlame:aid(50003)
qobThirdSealFlame:register()
