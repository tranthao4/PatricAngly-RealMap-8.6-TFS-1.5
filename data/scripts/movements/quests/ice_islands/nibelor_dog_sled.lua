...
local iceIslandsDogSled = MoveEvent()
iceIslandsDogSled:type("stepin")

function iceIslandsDogSled.onStepIn(creature, item, position, fromPosition)
...
iceIslandsDogSled:uid(12025, 12026, 12027, 12028)
iceIslandsDogSled:register()
