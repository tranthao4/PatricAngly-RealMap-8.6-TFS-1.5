local whatAFoolishDestroyPies = MoveEvent()
whatAFoolishDestroyPies:type("stepin")

function whatAFoolishDestroyPies.onStepIn(creature, item, position, fromPosition)
...
whatAFoolishDestroyPies:aid(50180)
whatAFoolishDestroyPies:register()
