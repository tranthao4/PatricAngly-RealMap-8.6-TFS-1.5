local isoyLastFight = MoveEvent()
isoyLastFight:type("stepin")

function isoyLastFight.onStepIn(creature, item, position, fromPosition)
...
isoyLastFight:uid(7809, 7810)
isoyLastFight:register()
