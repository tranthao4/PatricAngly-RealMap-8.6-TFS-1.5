...
local tatThalasPoisonTile = MoveEvent()
tatThalasPoisonTile:type("stepin")

function tatThalasPoisonTile.onStepIn(creature, item, position, fromPosition)
...
tatThalasPoisonTile:aid(50132)
tatThalasPoisonTile:register()
