...
local woteCrate = MoveEvent()
woteCrate:type("stepin")

function woteCrate.onStepIn(creature, item, position, fromPosition)
...
woteCrate:aid(8015, 8016, 8017, 8018, 8019, 8020, 8021, 8022, 8023, 32362)
woteCrate:id(11436)
woteCrate:register()
