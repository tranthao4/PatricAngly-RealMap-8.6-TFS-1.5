local demonOakEntrance = MoveEvent()
demonOakEntrance:type("stepin")

function demonOakEntrance.onStepIn(creature, item, position, fromPosition)
...
demonOakEntrance:aid(50082)
demonOakEntrance:register()
