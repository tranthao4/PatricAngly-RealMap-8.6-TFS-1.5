...
local dcDeathRingTeleport = MoveEvent()
dcDeathRingTeleport:type("stepin")

function dcDeathRingTeleport.onStepIn(creature, item, position, fromPosition)
...
dcDeathRingTeleport:aid(2247)
dcDeathRingTeleport:register()
