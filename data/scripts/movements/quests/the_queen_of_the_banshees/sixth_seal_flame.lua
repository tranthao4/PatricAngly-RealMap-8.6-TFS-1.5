...
local qobSixthSealFlame = MoveEvent()
qobSixthSealFlame:type("stepin")

function qobSixthSealFlame.onStepIn(creature, item, position, fromPosition)
...
qobSixthSealFlame:aid(50006)
qobSixthSealFlame:register()
