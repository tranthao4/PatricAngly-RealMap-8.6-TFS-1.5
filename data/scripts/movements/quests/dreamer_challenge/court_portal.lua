...
local dcCourtPortal = MoveEvent()
dcCourtPortal:type("stepin")

function dcCourtPortal.onStepIn(creature, item, position, fromPosition)
...
dcCourtPortal:aid(3200, 3201, 3202, 3203)
dcCourtPortal:register()
