...
local svargrondArenaPit = MoveEvent()
svargrondArenaPit:type("stepin")

function svargrondArenaPit.onStepIn(creature, item, position, fromPosition)
...
svargrondArenaPit:aid(25300, 25301, 25302, 25303, 25304, 25305, 25306, 25307, 25308, 25309, 25310)
svargrondArenaPit:register()
