local woteTeleportToZalamon = MoveEvent()
woteTeleportToZalamon:type("stepin")

function woteTeleportToZalamon.onStepIn(creature, item, position, fromPosition)
...
woteTeleportToZalamon:aid(8029)
woteTeleportToZalamon:register()
