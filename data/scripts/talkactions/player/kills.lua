local kills = TalkAction("!kills")

function kills.onSay(player, words, param)
    ...
    local killCount = math.ceil(skullTime / fragTime)
    ...
    local message = "You have " .. killCount .. " unjustified kill" ..
                        (killCount > 1 and "s" or "") ..
