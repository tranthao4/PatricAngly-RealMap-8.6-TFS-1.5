local function SwordofFuryDisappear(cid)
...
local rookgaardQuests = MoveEvent()
rookgaardQuests:type("stepin")

function rookgaardQuests.onStepIn(cid, item, pos, topos)
...
rookgaardQuests:aid(7000)
rookgaardQuests:register()
