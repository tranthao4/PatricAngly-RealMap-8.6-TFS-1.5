...
-- AddItem event
local dcStoneAddItem = MoveEvent()
dcStoneAddItem:type("additem")
dcStoneAddItem:tileItem(true)

function dcStoneAddItem.onAddItem(moveitem, tileitem, position)
...
dcStoneAddItem:aid(9030)
dcStoneAddItem:register()

-- StepIn event
local dcStoneTeleport = MoveEvent()
dcStoneTeleport:type("stepin")

function dcStoneTeleport.onStepIn(creature, item, position, fromPosition)
...
dcStoneTeleport:aid(9031)
dcStoneTeleport:register()
