local config = {
    ...
    [2] = {text = 'You hold up the skull and let it take a peek over the beautiful elven town through the dense leaves.', position = Position(32710, 31668, 1)},
    ...
    [6] = {text = 'Considering that higher places around here aren\'t that easy to reach, you think the view from here is tolerably good.', position = Position(32580, 32741, 4)},
...
local unnaturalSelectionMission2 = MoveEvent()
unnaturalSelectionMission2:type("stepin")

function unnaturalSelectionMission2.onStepIn(creature, item, position, fromPosition)
...
unnaturalSelectionMission2:aid(50177)
unnaturalSelectionMission2:register()
