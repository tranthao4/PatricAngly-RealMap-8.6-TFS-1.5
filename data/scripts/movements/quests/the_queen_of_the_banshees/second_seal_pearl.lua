...
local qobSecondSealPearl = MoveEvent()
qobSecondSealPearl:type("stepin")

function qobSecondSealPearl.onStepIn(creature, item, position, fromPosition)
...
qobSecondSealPearl:aid(50009)
qobSecondSealPearl:register()
