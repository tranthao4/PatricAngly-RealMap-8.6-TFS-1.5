...
local shatteredIslesTeleport = MoveEvent()
shatteredIslesTeleport:type("stepin")

function shatteredIslesTeleport.onStepIn(creature, item, position, fromPosition)
...
shatteredIslesTeleport:aid(50176)
shatteredIslesTeleport:register()
