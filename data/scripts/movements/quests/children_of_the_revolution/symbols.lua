local cotrSymbols = MoveEvent()
cotrSymbols:type("stepin")

function cotrSymbols.onStepIn(creature, item, position, fromPosition)
...
cotrSymbols:aid(8012)
cotrSymbols:register()
