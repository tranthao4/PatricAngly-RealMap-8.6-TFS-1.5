...
local tatTombTeleports = MoveEvent()
tatTombTeleports:type("stepin")

function tatTombTeleports.onStepIn(creature, item, position, fromPosition)
...
tatTombTeleports:uid(3950, 3951, 3952, 3953, 3954, 3955, 3956)
tatTombTeleports:register()
