...
local spikeTeleports = MoveEvent()
spikeTeleports:type("stepin")

function spikeTeleports.onStepIn(creature, item, position, fromPosition)
...
spikeTeleports:aid(4226, 4227, 4228, 4229, 4230, 4231, 4232, 4233, 4234, 4235, 4236, 4237, 4238, 4239, 4240, 4241, 4242, 4243)
spikeTeleports:register()
