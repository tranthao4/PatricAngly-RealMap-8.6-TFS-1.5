...
local shrinesEntrance = MoveEvent()
shrinesEntrance:type("stepin")

function shrinesEntrance.onStepIn(creature, item, position, fromPosition)
...
for uid, _ in pairs(portals) do
    shrinesEntrance:uid(uid)
end
shrinesEntrance:register()
