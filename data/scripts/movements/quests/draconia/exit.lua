...
local draconiaExit = MoveEvent()
draconiaExit:type("stepin")

function draconiaExit.onStepIn(creature, item, position, fromPosition)
...
draconiaExit:aid(4248)
draconiaExit:register()
