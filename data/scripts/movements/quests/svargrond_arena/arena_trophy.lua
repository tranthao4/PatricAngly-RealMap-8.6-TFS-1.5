local svargrondArenaTrophy = MoveEvent()
svargrondArenaTrophy:type("stepin")

function svargrondArenaTrophy.onStepIn(creature, item, position, fromPosition)
...
svargrondArenaTrophy:uid(23201, 23202, 23203)
svargrondArenaTrophy:register()
