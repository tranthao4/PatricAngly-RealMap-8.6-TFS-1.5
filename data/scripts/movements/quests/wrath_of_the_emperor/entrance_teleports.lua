local woteEntranceTeleports = MoveEvent()
woteEntranceTeleports:type("stepin")

function woteEntranceTeleports.onStepIn(creature, item, position, fromPosition)
...
woteEntranceTeleports:aid(8025)
woteEntranceTeleports:register()
