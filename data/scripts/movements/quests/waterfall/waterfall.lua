...
local waterfallQuest = MoveEvent()
waterfallQuest:type("stepin")

function waterfallQuest.onStepIn(creature, item, position, fromPosition)
...
waterfallQuest:aid(50179)
waterfallQuest:register()
