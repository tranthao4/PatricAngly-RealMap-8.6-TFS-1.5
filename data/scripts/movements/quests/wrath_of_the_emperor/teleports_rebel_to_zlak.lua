...
local woteTeleportsRebelToZlak = MoveEvent()
woteTeleportsRebelToZlak:type("stepin")

function woteTeleportsRebelToZlak.onStepIn(creature, item, position, fromPosition)
...
woteTeleportsRebelToZlak:aid(12382, 12383)
woteTeleportsRebelToZlak:register()
