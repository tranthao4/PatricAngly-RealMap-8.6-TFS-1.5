...
local beregarPythiusBoss = MoveEvent()
beregarPythiusBoss:type("stepin")

function beregarPythiusBoss.onStepIn(creature, item, position, fromPosition)
...
beregarPythiusBoss:aid(50126, 50127)
beregarPythiusBoss:register()
