local qobFirstSealFlame = MoveEvent()
qobFirstSealFlame:type("stepin")

function qobFirstSealFlame.onStepIn(creature, item, position, fromPosition)
...
qobFirstSealFlame:aid(50001)
qobFirstSealFlame:register()
