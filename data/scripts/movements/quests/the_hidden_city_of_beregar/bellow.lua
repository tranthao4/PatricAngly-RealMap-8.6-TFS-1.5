...
local beregarBellow = MoveEvent()
beregarBellow:type("stepin")

function beregarBellow.onStepIn(creature, item, position, fromPosition)
...
beregarBellow:aid(50119)
beregarBellow:register()
