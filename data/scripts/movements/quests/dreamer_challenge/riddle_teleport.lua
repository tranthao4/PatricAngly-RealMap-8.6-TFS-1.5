...
local dcRiddleTeleport = MoveEvent()
dcRiddleTeleport:type("stepin")

function dcRiddleTeleport.onStepIn(creature, item, position, fromPosition)
...
dcRiddleTeleport:aid(2249)
dcRiddleTeleport:register()
