local qobFifthSealFlame = MoveEvent()
qobFifthSealFlame:type("stepin")

function qobFifthSealFlame.onStepIn(creature, item, position, fromPosition)
...
qobFifthSealFlame:aid(50005)
qobFifthSealFlame:register()
