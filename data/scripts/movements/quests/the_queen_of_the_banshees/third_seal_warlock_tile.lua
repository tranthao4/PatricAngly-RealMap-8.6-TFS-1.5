local qobThirdSealWarlockTile = MoveEvent()
qobThirdSealWarlockTile:type("stepin")

function qobThirdSealWarlockTile.onStepIn(creature, item, position, fromPosition)
...
qobThirdSealWarlockTile:aid(50010)
qobThirdSealWarlockTile:register()
