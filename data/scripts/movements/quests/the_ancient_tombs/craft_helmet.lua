...
local tatCraftHelmet = MoveEvent()
tatCraftHelmet:type("additem")
tatCraftHelmet:tileItem(true)

function tatCraftHelmet.onAddItem(moveitem, tileitem, position)
...
tatCraftHelmet:aid(50146)
tatCraftHelmet:register()
