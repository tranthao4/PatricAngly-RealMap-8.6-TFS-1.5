...
local dcWallsTeleport = MoveEvent()
dcWallsTeleport:type("stepin")

function dcWallsTeleport.onStepIn(creature, item, position, fromPosition)
...
dcWallsTeleport:aid(2257)
dcWallsTeleport:register()
