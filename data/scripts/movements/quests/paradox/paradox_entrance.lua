local paradoxEntrance = MoveEvent()
paradoxEntrance:type("stepin")

function paradoxEntrance.onStepIn(cid, item, position, fromPosition)
...
paradoxEntrance:aid(13003)
paradoxEntrance:register()
