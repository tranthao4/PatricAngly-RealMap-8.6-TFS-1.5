...
local woteBossesTeleport = MoveEvent()
woteBossesTeleport:type("stepin")

function woteBossesTeleport.onStepIn(creature, item, position, fromPosition)
...
woteBossesTeleport:uid(3189, 3190, 3191, 3192)
woteBossesTeleport:register()
