...
local inquisitionEntrance = MoveEvent()
inquisitionEntrance:type("stepin")

function inquisitionEntrance.onStepIn(creature, item, position, fromPosition)
...
inquisitionEntrance:aid(2149)
inquisitionEntrance:register()
