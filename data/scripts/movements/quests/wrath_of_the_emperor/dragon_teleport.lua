local woteDragonTeleport = MoveEvent()
woteDragonTeleport:type("stepin")

function woteDragonTeleport.onStepIn(creature, item, position, fromPosition)
...
woteDragonTeleport:aid(8024)
woteDragonTeleport:register()
