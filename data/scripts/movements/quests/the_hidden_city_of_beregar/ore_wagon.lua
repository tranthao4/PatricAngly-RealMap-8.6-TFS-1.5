local beregarOreWagon = MoveEvent()
beregarOreWagon:type("stepin")

function beregarOreWagon.onStepIn(creature, item, position, fromPosition)
...
beregarOreWagon:aid(50095)
beregarOreWagon:register()
