...
local unnaturalSelectionMission3 = MoveEvent()
unnaturalSelectionMission3:type("stepin")

function unnaturalSelectionMission3.onStepIn(creature, item, position, fromPosition)
...
unnaturalSelectionMission3:aid(50178)
unnaturalSelectionMission3:register()
