...
local CHARACTER_DEFAULT = {
	TOWN = 1, -- Rookgaard (Town ID 1 should be Rookgaard in your map)
	POSX = 32097, -- Rookgaard temple position X
	POSY = 32219, -- Rookgaard temple position Y
	POSZ = 7, -- Rookgaard temple position Z
	LEVEL = 1, -- Start at level 1 for Rookgaard
	HEALTH = 150, -- Level 1 health
	MANA = 0, -- Level 1 mana (no mana at level 1)
	CAPACITY = 400, -- Base capacity
	SKILL = 10,
	STAMINA = 2520,
	SOUL = 0, -- No soul at level 1
	MAGIC_LEVEL = 0,
	OUTFIT_MALE = 128,
	OUTFIT_FEMALE = 136,
	OUTFIT_ADDONS = 0,
