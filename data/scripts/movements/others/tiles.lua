...
-- StepIn event
local tilesStepIn = MoveEvent()
tilesStepIn:type("stepin")

function tilesStepIn.onStepIn(creature, item, position, fromPosition)
...
tilesStepIn:id(416, 426, 446, 3216, 3202, 11062)
tilesStepIn:register()

-- StepOut event
local tilesStepOut = MoveEvent()
tilesStepOut:type("stepout")

function tilesStepOut.onStepOut(creature, item, position, fromPosition)
...
tilesStepOut:id(417, 425, 447, 3217, 3215, 11063)
tilesStepOut:register()
