local config = {
    ...
    brokenAmphoraId = 2252
}

local apeCityDeepestCatacombs = MoveEvent()
apeCityDeepestCatacombs:type("stepin")

function apeCityDeepestCatacombs.onStepIn(creature, item, position, fromPosition)
...
apeCityDeepestCatacombs:uid(12129, 12130)
apeCityDeepestCatacombs:register()
