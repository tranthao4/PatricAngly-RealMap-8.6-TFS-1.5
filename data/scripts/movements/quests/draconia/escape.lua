local draconiaEscape = MoveEvent()
draconiaEscape:type("stepin")

function draconiaEscape.onStepIn(creature, item, position, fromPosition)
...
draconiaEscape:aid(4249)
draconiaEscape:register()
