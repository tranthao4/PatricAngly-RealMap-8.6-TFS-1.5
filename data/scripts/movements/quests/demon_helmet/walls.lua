...
local demonHelmetWalls = MoveEvent()
demonHelmetWalls:type("stepin")

function demonHelmetWalls.onStepIn(creature, item, position, fromPosition)
...
demonHelmetWalls:aid(50152, 50153)
demonHelmetWalls:register()
