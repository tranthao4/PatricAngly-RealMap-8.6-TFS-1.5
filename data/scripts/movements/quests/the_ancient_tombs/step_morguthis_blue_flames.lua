...
local tatMorguthisBlueFlames = MoveEvent()
tatMorguthisBlueFlames:type("stepin")

function tatMorguthisBlueFlames.onStepIn(creature, item, position, fromPosition)
...
tatMorguthisBlueFlames:uid(50139, 50140, 50141, 50142, 50143, 50144, 50145, 50147)
tatMorguthisBlueFlames:register()
