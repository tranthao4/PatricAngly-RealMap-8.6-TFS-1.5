...
local poiThrones = MoveEvent()
poiThrones:type("stepin")

function poiThrones.onStepIn(creature, item, position, fromPosition)
...
poiThrones:uid(2080, 2081, 2082, 2083, 2084, 2085, 2086)
poiThrones:register()
