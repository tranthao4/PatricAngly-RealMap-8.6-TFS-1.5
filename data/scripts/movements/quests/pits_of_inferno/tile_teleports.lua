...
local poiTileTeleports = MoveEvent()
poiTileTeleports:type("stepin")

function poiTileTeleports.onStepIn(creature, item, position, fromPosition)
...
for aid, _ in pairs(config) do
    poiTileTeleports:aid(aid)
end
poiTileTeleports:register()
