local animationeffect = TalkAction("!x")

function animationeffect.onSay(player, words, param)
...
animationeffect:separator(" ")
animationeffect:access(true)
animationeffect:register()
