local mainOnAddItems = MoveEvent()
mainOnAddItems:type("additem")
mainOnAddItems:tileItem(true)

function mainOnAddItems.onAddItem(moveitem, tileitem, pos)
...
mainOnAddItems:aid(8001)
mainOnAddItems:register()
