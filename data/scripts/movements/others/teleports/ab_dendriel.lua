...
local abDendriel = MoveEvent()
abDendriel:type("stepin")

function abDendriel.onStepIn(creature, item, position, fromPosition)
...
abDendriel:aid(9700, 9701, 9702, 9703, 9704, 9705)
abDendriel:register()
