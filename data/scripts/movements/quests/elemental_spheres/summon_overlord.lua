...
local esSummonOverlord = MoveEvent()
esSummonOverlord:type("additem")
esSummonOverlord:tileItem(true)

function esSummonOverlord.onAddItem(moveitem, tileitem, position)
...
esSummonOverlord:id(8568, 8569, 8570, 8578)
esSummonOverlord:register()
