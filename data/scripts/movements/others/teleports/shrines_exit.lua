...
local shrinesExit = MoveEvent()
shrinesExit:type("stepin")

function shrinesExit.onStepIn(creature, item, position, fromPosition)
...
shrinesExit:aid(9117)
shrinesExit:register()
