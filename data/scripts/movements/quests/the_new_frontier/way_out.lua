local newFrontierWayOut = MoveEvent()
newFrontierWayOut:type("stepin")

function newFrontierWayOut.onStepIn(creature, item, position, fromPosition)
...
newFrontierWayOut:aid(50174)
newFrontierWayOut:register()
