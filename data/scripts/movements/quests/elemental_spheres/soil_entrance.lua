...
local esSoilEntrance = MoveEvent()
esSoilEntrance:type("stepin")

function esSoilEntrance.onStepIn(creature, item, position, fromPosition)
...
esSoilEntrance:uid(24541, 24542, 24543, 24544)
esSoilEntrance:register()
