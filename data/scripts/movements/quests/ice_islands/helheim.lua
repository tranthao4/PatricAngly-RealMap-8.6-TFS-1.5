local iceIslandsHelheim = MoveEvent()
iceIslandsHelheim:type("stepin")

function iceIslandsHelheim.onStepIn(creature, item, position, fromPosition)
    ...
    Position(position.x, position.y - 1, position.z):sendMagicEffect(CONST_ME_MAGIC_BLUE)
    return true
end

iceIslandsHelheim:aid(50160)
iceIslandsHelheim:register()
